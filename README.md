...
Este guia consolida padrões de:

- [`alofans-webpush`](https://github.com/) — microserviço dispatcher de push em Express + TS.
- [`alofans-frontend`](https://github.com/) — PWA com `injectManifest`, install prompt, auto-update.
- [`transport-frontend`](https://github.com/) — PWA com SSE provider robusto (heartbeat + reconexão), Zustand persist, RequestHandler.
- [`transport-admin-system`](https://github.com/) — admin web com `api-client.ts` tipado e React Query.
